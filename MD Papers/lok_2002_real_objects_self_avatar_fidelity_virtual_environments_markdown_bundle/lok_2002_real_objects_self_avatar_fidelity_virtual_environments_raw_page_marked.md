...
- This is an older VE/hybrid-environment paper with figures and tables; verify exact quotations and numerical claims against the original PDF before thesis use.
...
providing natural interactivity and visually-faithful self-
avatars.  In turn, this should improve task performance.   
...
The user is represented within the VE with a self-
avatar, either from a library of representations, a generic 
self-avatar, or no self-avatar.  A survey of VE research 
shows the most common approach is a generic self-avatar 
– literally, one size fits all [1].  The participant’s self-
avatars are typically stylized human models, such as those 
...
customizing [self-]avatar appearance [5].”  If the self-
avatar visual fidelity might affect sense-of-presence, 
...
Usoh-Slater Presence Questionnaire (SUS) [14], Guilford-
Zimmerman Aptitude Survey, Part 5: Spatial Orientation 
and 
the 
Kennedy 
– 
...
avatar visual fidelity improves task performance. 
...
environment (VFHE). They were primarily male (thirty-
three) undergraduate students enrolled at UNC-CH 
...
• 
One participant became nauseated and quit mid-
way through the experiment.  The pinch gloves 
