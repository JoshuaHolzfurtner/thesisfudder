...
Future challenges for vection research: deﬁnitions,
functional signiﬁcance, measures, and neural bases
...
(Deﬁning Vection) outlines the different ways that vection has been deﬁned in the literature
...
investigations.
Keywords: vection, self-motion perception, optic ﬂow, egomotion, conscious experience, functional signiﬁcance,
neural basis
INTRODUCTION
...
difﬁculties with existing subjective self-report measures of vection,
...
respectively,bytheseauthors”(p. 764). However,wewereunabletoﬁndanymention
...
these observers would from then on receive no stimulation indicat-
...
suggestion from A.Tschermak (1928, 1930),“Vektionen” and we dis-
...
Palmisano et al.
Challenges for vection research
FIGURE 2 | Various possible deﬁnitions of vection. Shaded boxes show
...
ﬁndingsarestillsomewhatcontroversial. Severalmorerecentstud-
...
callyinvestigatedwithcomputer-generateddisplays. Theseinclude
...
Palmisano et al.
Challenges for vection research
reported increases in vection strength. Observers in their exper-
...
nance imaging (fMRI) has been employed most frequently in these
...
several extrastriate areas such asV3A and MT/V5, before terminat-
...
Palmisano et al.
Challenges for vection research
FIGURE 7 | Representations of four different types of self-motion-consistent optic ﬂow.
...
ing results. Early research by Brandt and colleagues found evidence
...
15Thevestibularsystemof theinnereardetectsonlyacceleratingself-motions(Dich-
...
ies which claim to investigate self-motion fail to meet these criteria.
...
effekteundcircularvektion: ein beitrag zur optisch-vestibulären interaktion. Arch.
...
Ito, H., and Shibata, I. (2005). Self-motion perception from expanding and contract-
ing optical ﬂows overlapped with binocular disparity. Vision Res. 45, 397–402. doi:
...
and Palmisano,
S. (2008).
Effects of active and passive view-
point jitter on vection in depth.
Brain Res.
Bull.
77,
335–342.
