# Kalckert & Ehrsson 2017 — Onset Time of Ownership in the Moving Rubber Hand Illusion

## Extraction notes

- Source PDF: `fpsyg-08-00344.pdf`

- Clean reading copy with page markers preserved.

- Light cleanup only; no interpretive notes mixed into source text.

- Verify exact quotations, onset times, participant counts, percentile values, figures, tables, and statistical claims against the original PDF before thesis use.

- This is a high-priority methods/evaluation-timing source for movement-based ownership illusions; use cautiously when applying from rubber-hand work to XR rowing.
...
Braintrends Ltd, Applied
Neuroscience, Italy
Peggy L. St. Jacques,
University of Sussex, UK
*Correspondence:
Andreas Kalckert
a.kalckert@reading.edu.my
Specialty section:
...
Published: 10 March 2017
Citation:
Kalckert A and Ehrsson HH (2017)
The Onset Time of the Ownership
Sensation in the Moving Rubber Hand
Illusion. Front. Psychol. 8:344.
doi: 10.3389/fpsyg.2017.00344
The Onset Time of the Ownership
Sensation in the Moving Rubber
Hand Illusion
Andreas Kalckert1,2* and H. H. Ehrsson2
1 Psychology, University of Reading Malaysia, Iskandar Puteri, Malaysia, 2 Department of Neuroscience, Karolinska Institutet,
Stockholm, Sweden
...
Keywords: rubber hand illusion, sense of ownership, body perception, onset
INTRODUCTION
...
1
March 2017 | Volume 8 | Article 344
...
Moving Rubber Hand Illusion Onset
FIGURE 1 | Illustration of the moving rubber hand illusion setup. Participants make brisk extension movements with their real index fingers (inside the box),
...
provide information about the diﬀerent processes involved in
...
Kalckert and Ehrsson
Moving Rubber Hand Illusion Onset
In the present study, we measured the onset time of
...
and eliminate putative carry-over eﬀects.
...
the participants (=94) aﬃrmed ownership, i.e., gave a rating
...
aﬃrmed ownership in the passive asynchronous condition
...
p < 0.012), although the eﬀect size was small (r = 0.15).
Sixty participants who had aﬃrmed the illusion according to
...
diﬀerence (Z = −0.52, p = 0.958). Most participants experienced
Frontiers in Psychology | www.frontiersin.org
3
March 2017 | Volume 8 | Article 344
...
Kalckert and Ehrsson
Moving Rubber Hand Illusion Onset
FIGURE 2 | Median ownership scores in the different conditions. Participants experienced the illusion in the synchronous, but not asynchronous, condition.
...
and passive conditions, allowing for a more sensitive withinparticipant comparison. In this subgroup of participants (n = 41),
...
(SD 19.5) for the passive synchronous condition. This diﬀerence
was significant (Z = −2.469, p = 0.014), with a moderate eﬀect
...
Kalckert and Ehrsson
Moving Rubber Hand Illusion Onset
FIGURE 4 | Frequency distribution of the onset times in the active
...
Kalckert and Ehrsson
Moving Rubber Hand Illusion Onset
Pavone et al., 2016). In these applications, it is desirable to induce
...
instantaneously. However, it is diﬃcult to compare the present
results directly with studies of full-body avatars in virtual reality.
Obviously, the use of head-mounted displays and computergenerated graphics is one diﬀerence. However, more importantly,
...
et al., 2015), particularly once these include diﬀerent forms of
...
to induce the RHI can vary widely in diﬀerent experiments,
...
the moving RHI in most participants, allowing for more eﬃcient
experimental designs.
However, it is not clear why participants diﬀer in their
...
and Ehrsson, 2014a). It is not clear what determines the interindividual diﬀerences in the RHI, although one hypothesis is that
it might reflect individual diﬀerences in the relative weighting of
diﬀerent sensory modalities in the integration process (Kilteni
...
diﬀerences between individuals in the RHI paradigm that might
...
and passive illusions were well aﬃrmed in the questionnaire data
...
is triggered in both conditions and by the same type of visuoproprioceptive integration process. This result is also consistent
...
is, consistent with the idea that diﬀerent types of multisensory
...
critical diﬀerences between active and passive movements are the
involvement of (i) motor intentions, (ii) comparisons between
the predicted sensory consequences of the movement based on
eﬀerence copy and the actual sensory feedback, and (iii) the sense
...
Kalckert and Ehrsson
Moving Rubber Hand Illusion Onset
motor-related processes contribute to the emergence of the
...
while diﬀering in terms of agency and motor control processes
...
(Walsh et al., 2011). Other studies found no diﬀerence when
...
significantly higher aﬃrmative ownership ratings in the active
condition than for the passive condition, but this diﬀerence
was relatively small and not reproduced in the proprioceptive
drift. In a later study, we found no significant diﬀerence in
...
movements). Motor control processes can aﬀect basic sensory
processes through eﬀerence copy mechanisms (von Holst and
...
may be defined diﬀerently, but we introduced these for a practical
reason, which is that the diﬀerence between synchronous and
asynchronous stimulation is one of the most observed and
reliable eﬀects in RHI experiments (Botvinick and Cohen, 1998;
...
two diﬀerent situations of “owning” and “not owning” the model
...
diﬀerent subjective experiences (Longo et al., 2008).
...
the illusion beyond the typical questionnaire, proprioceptivedrift and GSR based measurements that have mainly been used
...
to investigate potential diﬀerences between the diﬀerent versions
of the illusion and the role of the diﬀerent processes, such as
multisensory integration and motor control processes, in the
experience of ownership of a moving body.
AUTHOR CONTRIBUTIONS
AK and HE designed the experiments. AK conducted the
experiment. AK analyzed the data. AK and HE wrote the
manuscript.
ACKNOWLEDGMENTS
We thank the participants for their participation and the
European Research Council, the Swedish Foundation for
Strategic Research, the James S. McDonnell Foundation, the
Swedish Research Council and Söderberska Stiftelsen for
financial support.
REFERENCES
...
Bays, P. M., and Wolpert, D. M. (2006). Computational principles of sensorimotor
control that minimize uncertainty and variability. J. Physiol. (Lond) 578,
387–396. doi: 10.1113/jphysiol.2006.120121
Blakemore, S.-J., Wolpert, D. M., and Frith, C. D. (1998). Central cancellation
of self-produced tickle sensation. Nat. Neurosci. 1, 635–640. doi: 10.1038/
2870
Botvinick, M., and Cohen, J. (1998). Rubber hands “feel” touch that eyes see. Nature
391, 756. doi: 10.1038/35784
Bourdin, P., Barberia, I., Oliva, R., and Slater, M. (2017). A virtual out-of-body
experience reduces fear of death. PLoS ONE 12:e0169343. doi: 10.1371/journal.
pone.0169343.s003
Frontiers in Psychology | www.frontiersin.org
7
March 2017 | Volume 8 | Article 344
...
Kalckert and Ehrsson
Moving Rubber Hand Illusion Onset
Braun, N., Emkes, R., Thorne, J. D., and Debener, S. (2016). Embodied
neurofeedback with an anthropomorphic robotic hand. Sci. Rep. 6:37696.
doi: 10.1038/srep37696
Braun, N., Thorne, J. D., Hildebrandt, H., and Debener, S. (2014). Interplay
of agency and ownership: the intentional binding and rubber hand illusion
paradigm combined. PLoS ONE 9:e111967. doi: 10.1371/journal.pone.0111967.
s001
...
concog.2015.01.007
Caspar, E. A., De Beir, A., Magalhaes De Saldanha Da Gama, P. A., Yernaux, F.,
Cleeremans, A., and Vanderborght, B. (2014). New frontiers in the rubber hand
experiment: when a robotic hand becomes one’s own. Behav. Res. 47, 744–755.
doi: 10.3758/s13428-014-0498-3
Collins, K. L., Guterstam, A., Cronin, J., Olson, J. D., Ehrsson, H. H., and
Ojemann, J. G. (2017). Ownership of an artificial limb induced by electrical
brain stimulation. Proc. Natl. Acad. Sci. U.S.A. 114, 166–171. doi: 10.1073/pnas.
1616305114
Dummer, T., Picot-Annand, A., Neal, T., and Moore, C. (2009). Movement and the
...
brain areas. J. Neurosci. 25, 10564–10573. doi: 10.1523/JNEUROSCI.0800-05.
2005
Ehrsson, H. H., Rosén, B., Stockselius, A., Ragnö, C., Köhler, P., and
Lundborg, G. (2008). Upper limb amputees can be induced to experience
a rubber hand as their own. Brain 131, 3443–3452. doi: 10.1093/brain/
awn297
...
Guterstam, A., Gentile, G., and Ehrsson, H. H. (2013). The invisible hand
illusion: multisensory integration leads to the embodiment of a discrete
volume of empty space. J. Cogn. Neurosci. 25, 1078–1099. doi: 10.3758/BF0319
8798
Jenkinson, P. M., and Preston, C. (2015). New reflections on agency and body
ownership: the moving rubber hand illusion in the mirror. Conscious. Cogn.
33, 432–442. doi: 10.1016/j.concog.2015.02.020
...
Kalckert, A., and Ehrsson, H. H. (2014a). The moving rubber hand illusion
revisited: comparing movements and visuotactile stimulation to induce
illusory ownership. Conscious. Cogn. 26, 117–132. doi: 10.1016/j.concog.2014.
02.003
Kalckert, A., and Ehrsson, H. H. (2014b). The spatial distance rule in the moving
and classical rubber hand illusions. Conscious. Cogn. 30, 118–132. doi: 10.1016/
j.concog.2014.08.022
Kilteni, K., Maselli, A., Körding, K. P., and Slater, M. (2015). Over my fake body:
body ownership illusions for studying the multisensory basis of own-body
perception. Front. Hum. Neurosci. 9:613. doi: 10.1016/j.neuropsychologia.2009.
10.028
...
7:e40867. doi: 10.1371/journal.pone.0040867.s006
...
Louzolo, A., Kalckert, A., and Petrovic, P. (2015). When passive feels
active–delusion-proneness alters self-recognition in the moving rubber
hand illusion. PLoS ONE 10:e0128549. doi: 10.1371/journal.pone.0128549.
s004
...
doi: 10.3389/fpsyg.2013.00604/abstract
Ma, K., and Hommel, B. (2015). The role of agency for perceived ownership in the
virtual hand illusion. Conscious. Cogn. 36, 277–288. doi: 10.1016/j.concog.2015.
07.008
...
reinnervation amputees. Brain 13, 747–758. doi: 10.1093/brain/awq361
...
Padrao, G., Gonzalez-Franco, M., Sanchez-Vives, M. V., Slater, M., and RodriguezFornells, A. (2015). Violating body movement semantics: neural signatures
of self-generated and external-generated errors. Neuroimage 124, 147–156.
doi: 10.1016/j.neuroimage.2015.08.022
Pavone, E. F., Tieri, G., Rizza, G., Tidoni, E., Grisoni, L., and Aglioti, S. M. (2016).
Embodying others in immersive virtual reality: electro-cortical signatures of
monitoring the errors in the actions of an avatar seen from a first-person
perspective. J. Neurosci. 36, 268–279. doi: 10.1523/JNEUROSCI.0494-15.2016
Perez-Marcos, D., Sanchez-Vives, M. V., and Slater, M. (2011). Is my hand
...
the 21-item Peters et al. Delusions Inventory (PDI). Schizophr. Bull. 30,
1005–1022.
Petkova, V. I., and Ehrsson, H. H. (2009). When right feels left: referral of touch
and ownership between the hands. PLoS ONE 4:e6933. doi: 10.1371/journal.
pone.0006933
Raspopovic, S., Capogrosso, M., Petrini, F. M., Bonizzato, M., Rigosa, J., Di
Pino, G., et al. (2014). Restoring natural sensory feedback in real-time
bidirectional hand prostheses. Sci. Transl. Med. 6:222ra19. doi: 10.1126/
scitranslmed.3006820
Romano, D., Caﬀa, E., Hernandez-Arieta, A., Brugger, P., and Maravita, A. (2015).
The robot hand illusion: inducing proprioceptive drift through visuo-motor
congruency. Neuropsychologia 70, 414–420. doi: 10.1016/j.neuropsychologia.
2014.10.033
Rosén, B., Ehrsson, H. H., Antfolk, C., Cipriani, C., Sebelius, F., and Lundborg, G.
(2009). Referral of sensation to an advanced humanoid robotic hand prosthesis.
Scand. J. Plast. Reconstr. Surg. Hand Surg. 43, 260–266. doi: 10.3109/
02844310903113107
Samad, M., Chung, A. J., and Shams, L. (2015). Perception of body ownership is
driven by bayesian sensory inference. PLoS ONE 10:e0117178. doi: 10.1371/
journal.pone.0117178.s003
...
Shergill, S. S., Bays, P. M., Frith, C. D., and Wolpert, D. M. (2003). Two eyes for an
eye: the neuroscience of force escalation. Science 301, 187. doi: 10.1126/science.
1085327
...
your body: how agency structures body-ownership. Conscious. Cogn. 15, 423–
432. doi: 10.1016/j.concog.2005.09.004
...
und
Peripherie.
Naturwissenschaften 20, 464–476.
Walsh, L. D., Moseley, G. L., Taylor, J. L., and Gandevia, S. C. (2011). Proprioceptive
signals contribute to the sense of body ownership. J. Physiol. (Lond) 589,
3009–3021. doi: 10.1113/jphysiol.2011.204941
Conflict of Interest Statement: The authors declare that the research was
conducted in the absence of any commercial or financial relationships that could
be construed as a potential conflict of interest.
The reviewer PSJ and the handling Editor declared their shared aﬃliation, and the
handling Editor states that the process nevertheless met the standards of a fair and
objective review.
Copyright © 2017 Kalckert and Ehrsson. This is an open-access article distributed
