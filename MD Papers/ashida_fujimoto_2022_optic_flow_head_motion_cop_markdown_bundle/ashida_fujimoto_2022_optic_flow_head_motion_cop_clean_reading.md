...
KEYWORDS
optic flow, postural control, head motion, centre of pressure, HMD, (Min.5-max. 8) 7
Introduction
...
sway induced by optic flow on a headmounted display.
...
studying the effect of optic flow on postural control (Bertenthal
...
while wearing an HMD, participants observed optic flow simulated
...
values indicate body motion in the direction of the simulated selfmotion, while negative values indicate body motion in the
...
t-test. The phase lags were analysed by a two-way repeatedmeasures ANOVA and a two-way Bayesian repeated-measures
ANOVA.
...
significantly lower rating than the 0.05-Hz and the 0.01-Hz
...
examined the anterior-posterior sway induced by forwardbackward optic flow. Other conditions such as those involving
...
manuscript, and both contributed to finalising it.
Funding
...
Fujimoto, K., and Ashida, H. (2020). Different head-sway responses to optic flow
in sitting and standing with a head-mounted display. Front. Psychol. 11, 577305.
doi:10.3389/fpsyg.2020.577305
Fujimoto, K., and Ashida, H. (2019). Larger head displacement to optic flow
presented in the lower visual field. Iperception. 10 (6), 204166951988690–17. doi:10.
...
Oculus Rift: A cost-effective tool for studying visual-vestibular interactions in selfmotion perception. Front. Psychol. 6, 248. doi:10.3389/fpsyg.2015.00248
...
Wenye, G. (2020). Detrended fluctuation analysis. MATLAB Central File
Exchange. Available at: https://www.mathworks.com/matlabcentral/fileexchange/
19795-detrended-fluctuation-analysis (Retrieved September 4, 2020).
Frontiers in Virtual Reality
frontiersin.org
08
Ashida and Fujimoto
