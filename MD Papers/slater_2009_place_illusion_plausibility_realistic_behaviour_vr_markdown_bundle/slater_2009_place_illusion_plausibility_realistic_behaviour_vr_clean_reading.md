# Slater 2009 — Place Illusion and Plausibility Can Lead to Realistic Behaviour in Immersive Virtual Environments

## Extraction notes

- Source PDF: `JH17 (immersive res).pdf`

- Clean reading copy with page markers preserved.

- Light cleanup only; no interpretive notes mixed into source text.

- Verify exact quotations, definitions, terminology, and cited examples against the original PDF before thesis use.

- This is a high-priority XR theory/definition source for immersion, sensorimotor contingencies, place illusion, plausibility illusion, and response-as-if-real.
...
Mel Slater1,2,*
1EVENT Lab, Institute for Brain, Cognition and Behavior (IR3C), ICREA-University
...
ultimate
display)
(Sutherland 1965) and for the past 20 years as practical, affordable and useful systems. The vast majority of
research and development in this area has been to use
it as a way to simulate physical reality. Yet it is a
medium that has the potential to go far beyond anything that has been experienced before in terms of
transcending the bounds of physical reality, through
transforming your sense of place and through noninvasive alterations of the sense of our own body. In
...
experience, with its own unique conventions and possibilities, a medium in which people respond with their
...
visual images displayed will be determined as a function of at least the position and orientation of the
...
today delivers stereo vision that is updated as a function of head tracking, possibly directional audio and
sometimes some type of limited haptic interface. For
example, the Cave (Cruz-Neira et al. 1993), is a
system where between four and six walls of an approximately 3 m3 room are back-projected stereo projection
...
physically
move
through a limited space and orient their head arbitrarily to be able to perceive (but not necessarily from
*melslater@ub.edu
...
surrounding, three-dimensional environment that contains static and dynamic objects, including possibly
representations
of
other
people
...
controlled wholly by a computer program). Participants can effect changes in the environment—for
example, if at least one hand is tracked, then the participant can grab objects and move them to different
locations, or carry out a variety of other types of interaction. Further details of such systems can be found in
Sanchez-Vives & Slater (2005).
Parameters that determine the quality of the experience include the graphics frame rate (how long it takes
...
rendered scene (how much objects appear geometrically to appear like what they are supposed to depict,
...
Immersive systems can be characterized by the sensorimotor contingencies (SCs) that they support. SCs
...
action for this IVR. Now imagine an environment displayed visually on a large back-projected screen—again
with head tracking. However, now when the participant looks far enough to one side visual elements
...
would be an example of a valid effectual action. Without the data glove, the moving and grasping action
...
if a participant in a virtual reality touches some arbitrary virtual object they would feel nothing. The
...
to go into an immersive system. The physical capabilities of these systems do not allow this. With an HMD
...
3550
M. Slater
Realistic behaviour in virtual reality
...
into an HMD without tracking. Hence there is a natural set of equivalence classes, of systems that can be
...
use the valid actions that one must learn for perception of a virtual reality displayed through a desktop
...
valid actions that are possible within the system. Generally, system A is at a higher level of immersion than
...
In this framework, displays and interactive capabilities are inseparable. Consider for example the issue of
...
will be limited by the resolution of the display. Relatively low visual display resolution will mean that the
...
next section, we discuss the consequences for participants of different levels of immersion embodied in
...
environment, the participant was in a virtual environment with a sense of being at the place depicted by
...
other multiple meanings that have since been attributed to the word ‘presence’. It is the strong illusion of
...
very narrow field of view (say 108 horizontally instead
of the more than 1808 of natural vision). Now since the
...
greater head movements and patterns of head movements to obtain the same information compared to
normal. This is not to say that eventually with sufficient movement and after a sufficiently long enough
...
immersion in terms of the range of SCs that are possible, and an immersion hierarchy formed by the extent
...
pixels. Moreover, A will expect, touch and feel nothing, except when bumping into the physical Cave
...
occur. Only in physical reality is it not normally possible to break those boundaries (except in illness or
brain damage that disrupts the motor and perceptual
process). In any kind of virtual system there will
always be limits beyond which SCs fail to be applicable. PI occurs to the extent to which participants
...
grasp of the way sensory stimulation varies as the perceiver moves).’ (Noe¨ 2004, p. 12). This also happens in
computer games, but the type of sensorimotor knowledge is different. To look to the left, users make use
...
Now return to the question as to whether it is possible, or indeed whether it makes sense, to talk of PI
within a desktop system such as a computer game or
online systems such as Second Life. Consider the following thought experiment (which as stated above is
realizable today with sufficient resources). A participant enters an immersive system such as a tracked
Cave
or
HMD
system, and
...
action within a particular virtual reality, so it is reasonable to consider that the same is the case with respect
...
respect to a particular type of system—more specifically within a particular equivalence class of such
...
support will also be qualitatively different. When talking of a system that has SCs roughly equivalent to
physical reality, a participant can experience the
qualia ‘just like being there’, meaning that the participant carries out the same physical actions in order to
...
system in conjunction with the extent to which the participant probes the system. Now compare this with a
...
trying or doing anything special, as soon as the participant enters the environment and especially as soon as
they move. In the case of a desktop system the situation is quite different; the feeling reported as ‘being
...
complex.
Evidence suggests that the use of the same questionnaire
to
measure
presence
across
...
between systems that are in the same immersion equivalent class. Imagine comparing different Cave systems or
3552
M. Slater
Realistic behaviour in virtual reality
Phil. Trans. R. Soc. B (2009)
...
though you know for sure that it is not). Based on evidence over many experiments, it appears that a key
component of Psi is that events in the virtual environment over which you have no direct control refer
directly to you.
Consider in a virtual reality that there is the appearance of a woman standing in front of you. Perceptually
...
asks you a question, and you automatically find yourself smiling back and responding to her question,
even though you know that no one is there. This scenario has been used in a study of how shy males respond
...
handshakes.
Just as PI is maintained through synchronous correlations between the act of moving and concomitant
...
and so on—changes associated with the internal feeling provoked by an entity that ‘looks at you’. Seeing
...
physical realism—witness people’s responses in the virtual
reprise
of
the
Stanley
...
responded
with
expressions of hurt and anger. The experimental participants responded with increasing anxiety with each
...
thoughts, provides another example. Here, participants in an immersive virtual environment with
virtual characters tend to report the same kinds of persecutory feelings that they would have in similar
...
The correlational principle as one of the major factors leading towards Psi appears to be critical. Here is
...
that when a physical plank was registered with the virtual plank, so that participants would feel the plank
...
had moving shadows and reflections of the participant’s (virtual) body that moved in real time as their
body moved (ray tracing), and the other did not (ray
casting). In a between-groups experiment we found
that arousal and anxiety (as measured by skin conductance, heart rate and heart rate variability) were
...
the virtual reprise of the Milgram obedience experiment, more than half of the subjects said afterwards
...
fused. As we have argued, the action involved in looking at your own body provides very powerful evidence
...
and you see the limbs of this virtual body move in synchrony. This is a very powerful event in the external
...
in
cognitive
neuroscience concerned with body ownership is based on
the
paradigm
called
the
...
hand position rather than to their true hand. If the tactile stimulation is not synchronous, then the illusion
does not occur. This has been repeated in a virtual
environment, and ownership of a virtual arm projecting in stereo out of the person’s body was evoked
...
to respond as if it were real. We call this ‘response-asif-real’ RAIR. This framework (immersion, PI, Psi, the
virtual body) leaves open many important questions.
First, what is the relationship of ‘reality’ to a firstorder system? We said that a first-order system has
...
Second, is PI with respect to any particular (equivalence) class of systems measurable? We suggest that
...
pitch and roll. Other things being equal, if a participant looks around a scene only using yaw head
...
my contention that provided there are no inconsistencies between these modalities, there can be PI in one
...
illusion, given the right physical set-up and the appropriate SCs in a particular modality, is automatic—it
can coexist with different (but not contradictory)
sensations in another modality.
Third, is Psi measureable? Since this is a new concept for virtual environments, this has not been
previously
attempted.
However,
it
...
the participant, who does not respond in any measurable way. This would be considered a ‘break in Psi’.
...
has not been considered in this paper. We have considered Psi as an automatic and rapid response of the
...
change responses away from the instinctive first reactions (to smile back at the character smiling at you,
...
taking place—how much do they conform to expectations
of
what
would
normally
...
particularly important when the IVR is used to construct an environment that is intended to study the
...
as achieved by events that are in relation to the participants (e.g. a person involved in a violent confrontation
...
in the context of a fight between rival football supporters, does not occur in a way that appears realistic to
the participant, then they are not likely to exhibit
RAIR. Therefore, in designing any virtual environment it is particularly important to model the events
...
system of tracking and displays, and the implementation
of
the
algorithms
needed
...
scenario and plausible interactions between the participant and objects and virtual characters in the
...
The word ‘presence’ has come to have multiple meanings, and it is difficult to have any useful scientific
...
to as ‘presence’ in the original literature: it is the feeling of being in the place depicted by the virtual
environment (even though you know that you are not
there). We call the Psi the illusion that what is happening is real (even though you know that it is not real).
...
everyday reality. A second-order system can be simulated within a first-order system and so on. In a firstorder system PI is made possible as a consequence of
...
Therefore, there is no numerical scale that can compare ‘presence’ across different immersive systems,
...
the situation depicted. It is maintained through correlations between actions and reactions, and correlations
...
with what would be expected in reality in similar circumstances. Psi relies on the process of inference
from evidence (perceptions) to issues concerning the
‘reality’ of the situation. Psi and PI may result in a participant within a virtual reality realistically responding
...
paper.
REFERENCES
Armel, K. C. & Ramachandran, V. S. 2003 Projecting sensations
to
external
objects:
evidence
...
Human–computer interaction: software and hardware interfaces (eds G. Salvendy & M. Smith), pp. 699–704.
...
Bystrom, K. E., Barfield, W. & Hendrix, C. 1999 A conceptual
model
of
the
sense
...
(doi:10.1518/
001872098779591386)
Ehrsson, H. H. 2007 The experimental induction of out-ofbody
experiences.
Science
317,
1048.
...
Neuropsychologia 36, 1133–1140. (doi:10.1016/S00283932(98)00006-2)
...
Freeman, D. et al. 2005a The psychology of persecutory ideation I—a questionnaire survey. J. Nerv. Ment. Dis. 193,
302–308. (doi:10.1097/01.nmd.0000161687.12931.67)
Freeman, D. et al. 2005b The psychology of persecutory
...
Brogni, A. & Slater, M. 2008 Temporal and spatial variations in presence: qualitative analysis of interviews from
...
environments. ACM Trans. Graph. 21, 645–652. (doi:10.
1145/566570.566630)
Minsky, M. 1980 Telepresence. Omni 45–52.
Noe¨, A. 2004 Action in perception. Cambridge, MA: MIT
Press.
O’Regan, J. K. & Noe¨, A. 2001a A sensorimotor account of
vision and visual consciousness. Behav. Brain Sci. 24,
939–973; discussion 973–1031.
O’Regan, J. K. & Noe¨, A. 2001b What it is like to see: a sensorimotor theory of perceptual experience. Synthese 129,
79–103. (doi:10.1023/A:1012699224677)
Pan, X. & Slater, M. 2007 A preliminary study of shy males
interacting with a virtual female. Paper read at PRESENCE 2007: The 10th Annual International Workshop
...
Sheridan, T. B. 1996 Further musings on the psychophysics of presence. Presence: Teleop. Virtual Environ. 5,
241–246.
...
Slater, M., Perez-Marcos, D., Ehrsson, H. H. & SanchezVives, M. 2008 Towards a digital body: the virtual arm
illusion. Front. Hum. Neurosci. 2, 6. (doi:10.3389/neuro.
09.006.2008)
Slater, M., Khanna, P., Mortensen, J. & Yu, I. 2009 Visual
realism enhances realistic response in an immersive virtual environment. IEEE Comput. Graph. Appl. 29, 76–84.
...
Slater, M. & Brooks Jr, F. P. 1999 Walking . walking-inplace . flying, in virtual environments. Paper read at
26th Annual Conf. on Computer Graphics and Interactive Techniques (SIGGRAPH).
