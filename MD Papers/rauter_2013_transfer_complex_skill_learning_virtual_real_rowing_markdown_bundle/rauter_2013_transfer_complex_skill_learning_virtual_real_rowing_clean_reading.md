...
Transfer of Complex Skill Learning from Virtual to Real
Rowing
Georg Rauter1,2*, Roland Sigrist1,2, Claudio Koch1,2, Francesco Crivelli1,2, Mark van Raai1,2,
Robert Riener1,2, Peter Wolf1,2
1 Sensory-Motor Systems (SMS) Lab, Institute of Robotics and Intelligent Systems (IRIS), ETH Zurich, Zurich, Switzerland, 2 Medical Faculty, University of Zurich, Zurich,
Switzerland
Abstract
...
Citation: Rauter G, Sigrist R, Koch C, Crivelli F, van Raai M, et al. (2013) Transfer of Complex Skill Learning from Virtual to Real Rowing. PLoS ONE 8(12): e82145.
doi:10.1371/journal.pone.0082145
Editor: Attila Szolnoki, Hungarian Academy of Sciences, Hungary
Received January 22, 2013; Accepted October 30, 2013; Published December 20, 2013
Copyright:  2013 Rauter et al. This is an open-access article distributed under the terms of the Creative Commons Attribution License, which permits
unrestricted use, distribution, and reproduction in any medium, provided the original author and source are credited.
Funding: This work was supported by ETH Zurich and the Swiss National Science Foundation (Grant: ‘‘:‘‘Impact of Different Feedback Modalities on Complex Skill
Learning’’, fund number: CR22I2_135105). The funders had no role in study design, data collection and analysis, decision to publish, or preparation of the
manuscript.
Competing Interests: The authors have declared that no competing interests exist.
* E-mail: georg.rauter@hest.ethz.ch
Introduction
...
constantly increasing performance of today’s computers, simulations of more and more complex motor tasks are possible, i.e. tasks
...
possibility enables the examination of the questionable generalization of conclusions drawn on simple laboratory tasks— which
...
Consequently, simulators can feature a comprehensive documentation of the learning progress of a trainee [14,15].— By learning,
...
1
December 2013 | Volume 8 | Issue 12 | e82145



<!-- page: 2 -->

due to limited resources, technical constraints, or safety restrictions, or because of too heavy and too bulky measurement systems
required assessing the performance under real conditions. Also,
the acceptance to apply measurement systems in real environments may be low, when their application exceeds a certain degree
...
In sports like table tennis and juggling, the focus lies on ‘‘handeye’’ coordination of movements, whereby haptic interaction
...
rendering of visual and auditory interactions with the environment, but also the realistic rendering of haptic interactions
...
connected to flywheel dissipators, which generated oar angleand oar velocity-dependent water resistances when the oar was
...
augmented feedback, i.e. extrinsic feedback that provides information beyond deceptively realistic simulation of the environment.
...
from simulator training to on-water rowing while just the rowing
...
transfer/development was assessed quantitatively through biomechanical performance measures and qualitatively through video
...
Scull Simulator
Setup.
For the current study, a single scull simulator was
...
the GUI: UDP-data provided by the XPC-target was transformed
...
movements that were sent to each graphics PC in form of UDPdata from the XPC-target (Figure 3). The graphical scene was
...
systems
KOar,r~fOar,rO;Oar,r x,Oar,ry,Oar,rzg
and
KOar,l~
fOar,lO;Oar,l x,Oar,ly,Oar,lzg (Figure 6). Consecutively, the horizontal oar angles h and the vertical oar angles d could be determined
...
3. the oar forces in three dimensional Cartesian space at the endeffectors of both oars (resolution of the force sensors at the endeffector in each drive train 12bit with a linearity of 0:1% over a
...
were processed by a rowing model. This rowing model determined
...
graphics (Figure 7).
Rowing Model.
For this study on transfer in sculling, a
...
from the control PC. The core of the setup is the XPC-target that calculates the real-time rowing model and the haptic interaction forces. This XPCtarget collects sensor data from the robot and sensors inside the CAVE, processes this data, and transfers it via different protocols to the other PCs
...
execution of the Matlab/SimulinkH model (0:001ms), a multibody
...
3. the center of gravity (COG) G of the system rower-boat-oars is
...
the ethics commission of ETH Zurich: EK_2010-N-53. Furthermore, all participants signed a written consent form prior to the
...
Training Goals.
To be able to determine individual developments in rowing technique after four training sessions, training
...
Training
on Water.
The on-water participants trained
together on four different days during 70 min (&10 min warmup and &60 min training) on the lake. Training in small groups is
...
rowing trainer, who performed the trainings, intended to use to
...
development of each participant. The PM covered four categories: the two technical aspects, i.e. ‘‘oar handling skills’’ and
‘‘coordination of body segments’’ and two general categories, i.e.
‘‘oar angles’’ and ‘‘power’’. ‘‘Oar handling skills’’, were represented by the following sub aspects: (i) ‘‘catch slip’’, (ii) ‘‘depth of
...
measures for the oars were derived from measurements on the lefthand oar, i.e. starboard oar in the simulator and on water. The
...
performance measures. A detailed description of all ten biomechanical performance measures can be found further down in this
chapter.
Only one out of three runs from baseline tests (one from onwater and one from the simulator condition) and one out of three
...
measure with index i, and m( PMi
j
j) is the mean of the absolute
...
Dbas{ret~ mean(PMret){mean(PMbas)
SDpooled
:
ð2Þ
...
Measures
1. Catch Slip.
The more direct the blade is moved into the
...
surface.
3. Striking out Before Catch.
The striking out movement is
...
dstrikeOut~dmax{d(h~0):
ð6Þ
For a good technique, no striking out movement should be
detected.
4. Overlap Legs-Trunk.
The correct coordination of the
...
overlaplegs{trunk~ tstopLeg{tstartTrunk
Tcycle
100:
ð7Þ
...
anthropometry.
5. Overlap Trunk-Arms.
The performance measure ‘‘overlap trunk-arms’’ overlaptrunk{arms quantifies the overlap in the
sequential movement of trunk and arms in percent of a rowing
cycle %cycle, similar to the ‘‘overlap legs-trunk’’:
overlaptrunk{arms~ tstopTrunk{tstartArms
Tcycle
100:
ð8Þ
...
6. Catch Angle.
The start/end of a rowing cycle, i.e. the start
...
of each stroke.
7. Release Angle.
The end of the drive-, or the start of the
...
8. Stroke Length.
The stroke length is the range of motion
...
9. Maximal Handle Power.
The maximal handle power
Pmax was calculated in the following way:
Pmax~max(Fhandle _xhandle),
ð10Þ
...
10. Average Handle Power.
The average handle power
Pmean was calculated in the following way:
Pmean~mean(Fhandle _xhandle):
ð11Þ
...
During the baseline and retention tests, all participants were
...
Table 3. Development of biomechanical performance measures in all participants from baseline to retention.
W1
W2
W3
W4
...
0/5
1/2
Simulator (S) and on-water tests (W) were quantified in terms of pooled standard deviation (SDpooled). A significant improvement/degradation in a technical aspect was indicated by values larger/smaller than one, respectively. Onwater performance was also qualitatively evaluated by video assessment (V) (24 to 4 in steps of 1: negative/positive values indicated a performance decrease/increase). Italic bold font: this particular aspect was instructed during
training. Empty cells: no video assessment was performed for this technical aspect.
doi:10.1371/journal.pone.0082145.t003
Skill Transfer in Rowing
PLOS ONE | www.plosone.org
12
December 2013 | Volume 8 | Issue 12 | e82145
...
However, participant ‘‘W4’’ improved significantly under both
...
and the rankings of the participants according to mean power
produced in the simulator and on water were similar (Figure 14).
An evaluation of the general development in rowing performance by the independent rowing trainer revealed an increase in
...
were on average one point superior to the initial skills of the onwater group. After retention tests, the simulator group showed still
...
involving hand-eye-coordination and provided augmented feedback or modifications of physical parameters in the simulator
...
nevertheless slight differences in initial skill-level between participants had to be expected. Furthermore, the participants were
...
study results, since the participants could have learnt from one
...
environmental conditions must still be learnt under real conditions. In general, all participants were satisfied with the special
...
Appendix S1
Detailed information on the rowing model.
(PDF)
Figure S1
Anti windup controller.
(TIF)
Figure S2
The CAD-design of the CAVE system in the
...
the coordinate system for the tendon-based parallel robots R and
the shortened rowing skiff B.
(TIF)
Acknowledgments
The authors would like to thank Remo Affentranger, Michael HeroldNadig, Raoul Maag, John Morrell, Alessandro Rotta, Pascal Wespe, and
Michael Weiss for their continuous and valuable support. Thanks also to all
participants for their flexibility and cooperation. Furthermore, the authors
want to thank the local boat-builder Sta¨mpfli Racing Boat AG, the
Akademischer Sportverband Zu¨rich (ASVZ), and the Grasshoppers Club
Zu¨rich for their support.
Author Contributions
Conceived and designed the experiments: GR RS CK FC MvR RR PW.
Performed the experiments: GR RS CK PW. Analyzed the data: GR RS
CK FC PW. Contributed reagents/materials/analysis tools: GR RS CK
FC MvR RR PW. Wrote the paper: GR RS CK FC MvR RR PW.
Development of the virtual scenarios for the current study: MvR.
References
1. Schmidt R, Wrisberg C (2008) Motor learning and performance: a situationbased learning approach. Human Kinetics Publishers.
2. Wachtel J, Walton D (1985) The future of nuclear power plant simulation in the
united states. Simulation for Nuclear Reactor Technology Cambridge: Cambridge University Press.
3. Pew R, Mavor A (1998) Modeling human and organizational behavior:
Application to military simulations. National Academies Press.
4. Bell H,WaagW(1998) Evaluating the effectiveness of flight simulators for training
combat skills: A review. The international journal of aviation psychology 8: 223–
242.
5. Rolfe J, Staples K (1988) Flight simulation, volume 1. Cambridge University
Press.
6. Rycroft M, Houston A, Barker A, Dahlstron E, Lewis N, et al. (1999) Training
astronauts using three-dimensional visualisations of the international space
station. Acta astronautica 44: 303–306.
7. Kaptein N, Theeuwes J, Van Der Horst R (1996) Driving simulator validity:
Some considerations. Transportation Research Record: Journal of the
Transportation Research Board 1550: 30–36.
8. Gaba D, DeAnda A (1988) A comprehensive anesthesia simulation environment:
re-creating the operating room for research and training. Anesthesiology 69:
387–394.
9. Issenberg S, McGaghie W, Hart I, Mayer J, Felner J, et al. (1999) Simulation
technology for health care professional skills training and assessment. JAMA: the
journal of the American Medical Association 282: 861–866.
10. Scalese R, Obeso V, Issenberg S (2008) Simulation technology for skills training
and competency assessment in medical education. Journal of general internal
medicine 23: 46–49.
11. Riener R, Haders M (2012) Virtual Reality in Medicine. Springer London.
doi:10.1007/978-1-4471-4011-5.
12. Wulf G, Shea CH (2002) Principles derived from the study of simple skills do not
generalize to complex skill learning. Psychonomic bulletin & review 9: 185–211.
13. Krakauer J,Mazzoni P (2011) Human sensorimotor learning: adaptation, skill,
and beyond. Current opinion in neurobiology 21: 636–644.
14. O’Toole RV, Playter RR, Krummel TM, Blank WC, Cornelius NH, et al.
(1999) Measuring and developing suturing technique with a virtual reality
surgical simulator. Journal of the American College of Surgeons 189: 114.
15. Roenker DL, Cissell GM, Ball KK, Wadley VG, Edwards JD (2003) Speed-ofprocessing and driving simulator training result in improved driving performance. Human Factors: The Journal of the Human Factors and Ergonomics
Society 45: 218–233.
16. Bronkhorst AW, Veltman JA, Van Breda L (1996) Application of a threedimensional auditory display in a flight task. Human factors 38: 23–33.
17. Tannen RS, Nelson WT, Bolia RS, Warm J, Dember WN (2004) Evaluating
adaptive multisensory displays for target localization in a flight task. The
International journal of aviation psychology 14: 297–312.
18. Liu YC (2001) Comparative study of the effects of auditory, visual and
multimodality displays on drivers performance in advanced traveller information
systems. Ergonomics 44: 425–442.
19. Sigrist R, Rauter G, Riener R, Wolf P (2013) Augmented visual, auditory,
haptic, and multimodal feedback in motor learning: A review. Psychonomic
bulletin & review 20: 21–53.
20. Govil A, You S, Neumann U (2000) A video-based augmented reality golf
simulator. In: Proceedings of the 8th ACM International Conference on
Multimedia. Marina del Rey, California, , USA: ACM, New York, USA, pp.
489–490.
21. Salansky W (1993). Ball-throwing device, in particular for tennis balls. EP Patent
0,383,892.
22. Ito S, Asai T, Seo K, Koike S (2010) Development and performance of a ball
shooting machine. Procedia Engineering 2: 2649–2652.
23. Frisoli A, Ruffaldi E, Bagnoli L, Filippeschi A, Avizzano CA, et al. (2008)
Preliminary design of rowing simulator for in-door skill training. In: Proceedings
of the 2008 Ambi-Sys workshop on Haptic user interfaces in ambient media
systems. Quebec City, Canada: ICST Institute for Computer Sciences, SocialInformatics and Telecommunications Engineering, pp. 1–8.
24. Ruffaldi E, Gonzales O, Filippeschi A, Frisoli A, Avizzano C, et al. (2009)
Integration of multimodal technologies for a rowing platform. In: Proceedings of
the 5th IEEE International Conference on Mechatronics. Malaga, Spain.
25. von Zitzewitz J, Wolf P, Novakovic V, Wellner M, Rauter G, et al. (2008) Realtime rowing simulator with multimodal feedback. Sports Technology 1: 257–
266.
26. Tang J, Carignan C, Olsson P (2006) Tandam canoeing over the internet using
haptic feedback. In: Symposium on Haptic Interfaces for Virtual Environment
and Teleoperator Systems. Alexandria, Virginia, USA, pp. 281–285.
27. Carraro GU, Cortes M, Edmark JT, Ensor JR (1998) The peloton bicycling
simulator. In: Proceedings of the third symposium on Virtual reality modeling
language. ACM New York, NY, USA, pp. 63–70.
28. Mestre D, Maı¨ano C, Dagonneau V, Mercier C (2011) Does virtual reality
enhance exercise performance, enjoyment, and dissociation? an exploratory
study on a stationary bike apparatus. Presence: Teleoperators and Virtual
Environments 20: 1–14.
29. Kelly A, Hubbard M (2000) Design and construction of a bobsled driver training
simulator. Sports Engineering 3: 13–24.
30. Go¨bel S, Geiger C, Heinze C, Marinos D (2010) Creating a virtual archery
experience. In: Proceedings of the International Conference on Advanced Visual
Interfaces. Rome, Italy: ACM, pp. 337–340. doi: 10.1145/1842993.1843056.
31. Multon F, Hoyet L, Komura T, Kulpa R (2007) Interactive control of physicallyvalid aerial motion: application to VR training system for gymnasts. In:
Proceedings of the 2007 ACM symposium on Virtual reality software and
technology. ACM, pp. 77–80. doi:10.1145/1315184.1315196.
32. Drobny D, Borchers J (2010) Learning basic dance choreographies with different
augmented feedback modalities. In: Proceedings of the 28th of the international
conference extended abstracts on Human factors in computing systems. ACM,
pp. 3793–3798. doi:10.1145/1753846.1754058.
33. Nakamura A, Tabata S, Ueda T, Kiyofuji S, Kuno Y (2005) Multimodal
presentation method for a dance training system. In: CHI’05 extended abstracts
on Human factors in computing systems. ACM, pp. 1685–1688.
34. Gopher D (2012) Skill training in multimodal virtual environments.
Work: A Journal of Prevention, Assessment and Rehabilitation 41: 2284–2287.
35. Todorov E, Shadmehr R, Bizzi E (1997) Augmented feedback presented in a
virtual environment accelerates learning of a difficult motor task. Journal of
Motor Behavior 29: 147–158.
36. Wolpert D, Flanagan J (2010) Motor learning. Current biology 20: R467–R472.
37. Lammfromm R, Gopher D (2011) Transfer of skill from a virtual reality trainer
to real juggling. In: The International Conference SKILLS. volume 1.
38. Oosterhout G, Rekers C (1993). Rowing ergometer. EP Patent 0,376,403.
39. Henry JC, Clark RR, McCabe RP, Vanderby Jr R (1995) An evaluation of
instrumented tank rowing for objective assessment of rowing performance.
Journal of sports sciences 13: 199–206.
40. Marchal-Crespo L, Rauter G, Wyss D, von Zitzewitz J, Riener R (2012)
Synthesis and control of a parallel tendon-based robotic tennis trainer. In:
Proceedings of the IEEE BioRob. Rome,Italy: IEEE.
41. von Zitzewitz J, Morger A, Rauter G, Marchal-Crespo L, Wyss D, et al. (2012) A
reconfigurable, tendonbased haptic interface for research into human-environment interactions. Robotica 18: 687–689.
42. Rauter G (2008) Regelungstechnische und mechanische Studie eines Antriebsstranges fu¨r einen Seilroboter als haptisches Display. Master’s thesis, Graz
University of Technology.
43. Rauter G, von Zitzewitz J, Duschau-Wicke A, Vallery H, Riener R (2010) A
tendon based parallel robot applied to motor learning in sports. In: Proceedings
of the IEEE BioRob. Tokyo, Japan.
44. Rauter G, Baumgartner L, Denoth J, Riener R, Wolf P (2012) Optimisation of
the mean boat velocity in rowing. Computer methods in biomechanics and
biomedical engineering 15: 815–824.
45. Cabrera D, Ruina A, Kleshnev V (2006) A simple 1+ -dimensional model of
rowing mimics observed forces and motions. Human Movement Science 25:
192–220.
46. Azcueta R (2002) Computation of turbulent free-surface flows around ships and
floating bodies. Ship Technology Research 49: 46–69.
47. Altenburg D,Mattes K, Steinacker J (2008) Handbuch Rudertraining. Limpert
Verlag GmbH,Wiebelsheim, 1. auflage edition.
48. Sigrist R, Rauter G, Riener R, Wolf P (2013 in press) Terminal feedback
outperforms concurrent visual, auditory, and haptic feedback in learning a
complex rowing-type task. Journal of Motor Behavior.
Skill Transfer in Rowing
PLOS ONE | www.plosone.org
17
December 2013 | Volume 8 | Issue 12 | e82145
...
49. von Zitzewitz J, Rauter G, Steiner R, Brunschweiler A, Riener R (2009) A
versatile wire robot concept as a haptic interface for sport simulation. In:
Proceedings of the 2009 IEEE International Conference on Robotics and
Automation (ICRA). pp. 313–318.
50. von Zitzewitz J, Rauter G, Vallery H, Morger A, Riener R (2010) Forward
kinematics of redundantly actuated, tendon-based robots. In: Intelligent Robots
and Systems (IROS), 2010 IEEE/RSJ International Conference on. IEEE, pp.
2289–2294.
51. Kleshnev V (2009) Vertical oar angles. Rowing Biomachnics Newsletter.
52. Kleshnev V (2011) Rowing technique improvement using biomechanical testing.
Rowing biomechanics.
53. Witmer BG, Singer MJ (1998) Measuring presence in virtual environments: A
presence questionnaire. Presence: Teleoperators and Virtual Environments 7:
225–240.
54. Miles HC, Pop SR, Watt SJ, Lawrence GP, John NW (2012) A review of virtual
environments for training in ball sports. Computers & Graphics 36: 714–726.
55. Ericsson K (2001) The path to expert golf performance: Insights from the
masters on how to improve performance by deliberate practice. Optimising
performance in golf : 1–57.
56. Johard L, Filippeschi A, Ruffaldi E (2011) Real-time error detection for a rowing
training system. In: The International Conference SKILLS. volume 1.
Skill Transfer in Rowing
PLOS ONE | www.plosone.org
18
December 2013 | Volume 8 | Issue 12 | e82145
