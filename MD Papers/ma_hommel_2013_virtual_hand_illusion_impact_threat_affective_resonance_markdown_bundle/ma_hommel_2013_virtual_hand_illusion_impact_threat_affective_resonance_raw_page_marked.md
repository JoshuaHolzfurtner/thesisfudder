# Ma & Hommel 2013 — Virtual-Hand Illusion, Impact, Threat, and Affective Resonance

## Extraction notes

- Source PDF: `fpsyg-04-00604.pdf`
...
- Verify exact quotations, questionnaire wording, SCR statistics, figure/table claims, and interpretation of impact/threat conditions against the original PDF before thesis use.

- This is a caution source for threat/impact probes: strong threat responses may not cleanly indicate body ownership.
...
The virtual-hand illusion: effects of impact and threat on
perceived ownership and affective resonance
...
Edited by:
Petko Kusev, Kingston University,
UK
Reviewed by:
Harry Purser, Kingston University,
UK
Michael J. Taylor, Imperial College
London, UK
*Correspondence:
Ke Ma, Cognitive Psychology Unit,
Institute for Psychological Research,
Leiden University, Wassenaarseweg
52, 2333 AK Leiden, Netherlands
e-mail: k.ma@fsw.leidenuniv.nl
The rubber hand illusion refers to the observation that participants perceive “body
ownership” for a rubber hand if it moves, or is stroked in synchrony with the participant’s
real (covered) hand. Research indicates that events targeting artiﬁcial body parts can
trigger affective responses (affective resonance) only with perceived body ownership,
while neuroscientiﬁc ﬁndings suggest affective resonance irrespective of ownership (e.g.,
when observing other individuals under threat). We hypothesized that this may depend on
the severity of the event. We ﬁrst replicated previous ﬁndings that the rubber hand illusion
...
hand that they did not perceive as their own. Our ﬁndings suggest that perceived body
...
INTRODUCTION
In the “rubber-hand illusion” (RHI) ﬁrst reported by Botvinick
...
“emotional involvement” with the artiﬁcial hand.
...
about what they perceive as belonging to the body of someone
else.
Even though this interpretation ﬁts with previous observations
...
ownership, which does not seem to ﬁt with Yuan and Steed’s
...
ownership would be signiﬁcantly reduced in the asynchronous
...
clearly visible to the participant, it is difﬁcult to judge from the
...
Before conducting the actual experiment, we ﬁrst investigated
...
was accompanied by a vibration in the palm of their own hand
...
one on each ﬁnger and one on the palm; they are programmable
...
September 2013 | Volume 4 | Article 604 | 2
```
...
Ma and Hommel
The virtual-hand illusion
character set and imported the tracker and data glove mod-
...
asked to move their ﬁngers for 30 s in front of the black screen,
...
move ﬁngers and wrist for 1 min. In visual-tactile trials, they were
...
and Questions 5, 8, 9 are usually considered ﬁllers. In the pilot,
...
Because Questions 1, 2, and 6 were speciﬁc to the tactile modal-
...
www.frontiersin.org
September 2013 | Volume 4 | Article 604 | 3
```
...
orientation tracker on their right wrists, and the SCR ﬁnger elec-
...
experiment. We deﬁned a latency onset window between 1 and
...
Frontiers in Psychology | Cognition
September 2013 | Volume 4 | Article 604 | 4
```
...
for more detailed analyses. Figure 4 shows the outcome. The main
...
ship and affective resonance. The ﬁndings from the impact con-
...
At the same time, the ﬁndings from our threat condition show
...
previous neuroscientiﬁc observations, suggesting that threat tar-
...
ﬁndings demonstrate, such evidence of affective resonance is not
...
if a threat is only sufﬁciently serious. It is thus possible that cross-
personal affective resonance can only be obtained in the face of
events that are as serious as a ﬂesh-cutting knife or a pricking
...
P-values for the main effects of synchronicity are shown in the last row.
www.frontiersin.org
September 2013 | Volume 4 | Article 604 | 5
```
...
Ma and Hommel
The virtual-hand illusion
needle (as in several neuroimaging studies), but not with less
...
sufﬁciently threatening to activate the fast, direct pathway while
...
that a similar scenario holds for the successful neuroscientiﬁc
...
our ﬁndings strongly suggest that perceived body ownership and
...
process.
ACKNOWLEDGMENTS
The research of Ke Ma is supported by a post-graduate scholar-
ship (PhD) of the China Scholarschip Council (CSC). The study
was made possible by an infrastructure grant of the Netherlands
Research Organization (NWO middelgroot).
SUPPLEMENTARY MATERIAL
The Supplementary Material for this article can be found
online at: http://www.frontiersin.org/Cognition/10.3389/fpsyg.
2013.00604/abstract
REFERENCES
Armel, K. C., and Ramachandran, V.
S. (2003). Projecting sensations to
external objects: evidence from skin
conductance response. Proc. R. Soc.
Lond. B Biol. Sci. 270, 1499–1506.
...
(2011).
Electrodermal
Activity. Heidelberg: Springer.
Deutch, A. Y., and Roth, R. H. (1990).
The determinants of stress-induced
activation of the prefrontal cortical
dopamine system. Prog. Brain Res.
85, 367–403. doi: 10.1016/S0079-
6123(08)62691-6
Figner, B., and Murphy, R. O. (2010).
“Using
skin
conductance
in
...
Methods
for
Decision Research: A Critical Review
and User’s Guide, eds M. Schulte-
Mecklenbeck, A. Küehberger, and R.
Ranyard (New York, NY: Psychology
Press), 163–184.
Gallese, V., Keysers, C., and Rizzolatti,
G. (2004). A unifying view of
the
basis
of
social
cognition.
Trends Cogn. Sci. 8, 396–403. doi:
...
(2009). How social are task rep-
resentations?
Psychol.
Sci.
20,
794–798. doi: 10.1111/j.1467-9280.
2009.02367.x
...
N.
(2004).
Vicarious responses to pain in ante-
rior cingulate cortex: is empathy
a multisensory issue? Cogn. Affect.
Behav. Neurosci. 4, 270–278.
Murphy, B. L., Arnsten, A. F. T.,
Goldman-Rakic,
P.
S.,
and
...
(1996).
Increased
dopamine turnover in the pre-
frontal
cortex
impairs
spatial
working-memory performance in
rats and monkeys. Proc. Natl. Acad.
Sci. U.S.A. 93, 1325–1329. doi:
10.1073/pnas.93.3.1325
Padilla, M. A., Pabon, S., Frisoli,
A., Sotgiu, E., Loconsole, C., and
Bergamasco, M. (2010). “Hand and
arm ownership illusion through
virtual reality physical interaction
and vibrotactile stimulations,” in
Haptics: Generating and Perceiving
Tangible Sensations, eds A. M. L.
Kappers, J. B. F. van Erp, W. M.
Bergmann Tiest, and F. C. T. van
der Helm (Heidelberg: Springer),
194–199.
Sanchez-Vives, M. V., Spanlang, B.,
Frisoli, A., Bergamasco, M., and
Slater, M. (2010). Virtual hand illu-
sion induced by visuomotor corre-
lations. PLoS ONE 5:e10381. doi:
...
arm
illusion.
Front. Hum. Neurosci. 2:6. doi:
10.3389/neuro.09.006.2008
Tsakiris, M., and Haggard, P. (2005).
The rubber hand illusion revisited:
visuotactile integration and self-
attribution. J. Exp. Psychol. Hum.
Percept. Perform. 31, 80–91. doi:
10.1037/0096-1523.31.1.80
Yuan, Y., and Steed, A. (2010). “Is
the rubber hand illusion induced
by immersive virtual reality?” in
IEEE Virtual Reality conference, VR
2010, eds B. Lok, G. Klinker, and
R. Nakatsu (Waltham, MA: IEEE
Computer Soc), 95–102.
...
conﬂict of interest.
Received: 19 June 2013; accepted: 20
August
2013;
published
online:
06
September 2013.
Citation: Ma K and Hommel B (2013)
The virtual-hand illusion: effects of
impact and threat on perceived own-
ership and affective resonance. Front.
Psychol.
4:604.
doi:
10.3389/fpsyg.
...
Frontiers in Psychology | Cognition
September 2013 | Volume 4 | Article 604 | 6
```
